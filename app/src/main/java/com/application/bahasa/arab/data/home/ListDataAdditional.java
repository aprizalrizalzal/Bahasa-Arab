...
public class ListDataAdditional {

    public static List<ModelAdditional> listModelAdditional(){
        ArrayList<ModelAdditional> modelAdditionalArrayList = new ArrayList<>();
        modelAdditionalArrayList.add(new ModelAdditional(
                "Kosa Kata Pendukung",
                "Halaman 379/386",
        ...
        modelAdditionalArrayList.add(new ModelAdditional(
                ...
                ""));
        return modelAdditionalArrayList;
    }
}
