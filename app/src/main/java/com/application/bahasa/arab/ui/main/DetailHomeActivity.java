...
import com.application.bahasa.arab.utils.ScrollHandle;
...
public class DetailHomeActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagePlay.setOnClickListener(v -> playMedia());

        imagePause.setOnClickListener(v -> pauseMedia());

        imageStop.setOnClickListener(v -> stopMedia());
        ...
        if (mediaPlayer != null){
            ...
            if (audio !=null){
                ...
                if (audioTitle !=null) {
                    ...
                    if (mediaPlayer == null){
                        Toast.makeText(DetailHomeActivity.this, getString(R.string.media_is_empty),Toast.LENGTH_SHORT).show();
                    }else {
                        mediaPlayer.start();
                        imagePlay.setVisibility(View.INVISIBLE);
                        imagePause.setVisibility(View.VISIBLE);
