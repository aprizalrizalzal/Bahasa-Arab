...
public class ListDataSemester {

    public static List<ModelSemester> listDataSemester(){
        ArrayList<ModelSemester> modelSemesterArrayList = new ArrayList<>();
        modelSemesterArrayList.add(new ModelSemester(
                "Semester Satu",
                "Halaman 1/114",
