...
public class ListDataViewAdditional {
    ...
    public static List<DataModelAdditional> listDataModelAdditionals(){
        ...
        dataModelAdditionalArrayList.add(new DataModelAdditional(
                ...
                "https://firebasestorage.googleapis.com/v0/b/bahasa-6a723.appspot.com/o/bahasa-arab%2Fmp3%2Fsample.mp3?alt=media&token=479bfe3a-a065-44c6-b6d5-f5597fdd888e",
                "kosa-kata-pendukung.pdf"));
        dataModelAdditionalArrayList.add(new DataModelAdditional(
                "ba18",
                ...
                "https://firebasestorage.googleapis.com/v0/b/bahasa-6a723.appspot.com/o/bahasa-arab%2Fmp3%2Fsample.mp3?alt=media&token=479bfe3a-a065-44c6-b6d5-f5597fdd888e",
                "daftar-kosa-kata-setiap-unit.pdf"));
        dataModelAdditionalArrayList.add(new DataModelAdditional(
                "ba19",
