...
public class DataModelProfileOrContact {
    ...
    public DataModelProfileOrContact(String id, String phoneNumber, String studentName, String studentIdNumber, String profilePictureInTheURL) {
        this.id = id;
    ...
    public DataModelProfileOrContact() {
    }
